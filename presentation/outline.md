...
| 20 | hero light | 最后要看哪些取舍？ | 扩展与安全总览 |
| 21 | dark | Pi 没有内置 MCP，如何扩展？ | `core/extensions/types.ts` |
| 22 | light | 项目信任、工具权限和沙箱是什么关系？ | `coding-agent/docs/security.md` |
| 23 | dark | 零基础读者下一步按什么顺序读源码？ | 五个关键源码入口 |
| 24 | hero dark | 一句话怎样变成可验证的行动？ | 全链路回顾 |
...
- 贯穿任务在 04、05、12、14、17、18、19、24 页重复出现，避免读者丢失上下文。
